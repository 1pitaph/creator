...
const AceternityLogo = () => (
  <svg width="66" height="65" viewBox="0 0 66 65" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-3 w-3 text-black" aria-hidden="true" focusable="false">
    <path
...
export const HoverBorderGradientButton = ({ ariaLabel, onClick }: { ariaLabel: string; onClick: () => void }) => (
  <button
    type="button"
    className={cn(
      "group/ask relative flex h-min w-fit flex-col flex-nowrap content-center items-center justify-center overflow-hidden rounded-full border bg-black/20 p-px decoration-clone shadow-[0_10px_26px_rgba(24,24,27,0.10)] transition duration-300 hover:bg-black/10 hover:shadow-[0_14px_34px_rgba(24,24,27,0.14)] focus:outline-none focus-visible:ring-2 focus-visible:ring-violet-200"
    )}
  ...
  >
    ...
    <span className="relative z-10 flex w-auto items-center gap-2 rounded-[inherit] bg-white px-4 py-2 text-black">
      <AceternityLogo />
