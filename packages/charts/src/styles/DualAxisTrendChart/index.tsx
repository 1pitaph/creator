...
const DualAxisTrendChart = memo(function DualAxisTrendChart({ intent, metrics, className, height = 260, ariaLabel }: ChartStyleProps) {
  const spec = useMemo(() => buildDualAxisTrendSpec(intent, metrics), [intent, metrics]);
